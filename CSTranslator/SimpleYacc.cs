...
public enum Tokens {
    ...
    COLUMN=19,IF=20,ELSE=21,THEN=22,INUM=23,RNUM=24,
    ID=25};
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[12] = new State(new int[]{13,13,14,23,4,-14,10,-14,21,-14});
    states[13] = new State(new int[]{25,18,23,19,17,20},new int[]{-4,14,-5,27,-3,17});
    states[14] = new State(new int[]{15,15,16,25,13,-15,14,-15,4,-15,10,-15,21,-15,18,-15,25,-15,3,-15,5,-15,11,-15,12,-15,20,-15,22,-15});
    ...
    states[24] = new State(new int[]{15,15,16,25,13,-16,14,-16,4,-16,10,-16,21,-16,18,-16,25,-16,3,-16,5,-16,11,-16,12,-16,20,-16,22,-16});
    states[25] = new State(new int[]{25,18,23,19,17,20},new int[]{-5,26,-3,17});
    states[26] = new State(-19);
    states[27] = new State(-20);
    states[28] = new State(new int[]{15,15,16,25,13,-17,14,-17,4,-17,10,-17,21,-17,18,-17,25,-17,3,-17,5,-17,11,-17,12,-17,20,-17,22,-17});
    states[29] = new State(-6);
    states[30] = new State(-7);
    states[31] = new State(new int[]{25,18,23,19,17,20},new int[]{-2,32,-4,28,-5,27,-3,17});
    states[32] = new State(new int[]{13,13,14,23,25,18,3,4,5,31,11,35,12,40,20,48,4,-12,10,-12,21,-12},new int[]{-6,33,-7,9,-3,10,-8,29,-9,30,-10,34,-12,39,-11,46,-14,47});
    ...
    states[42] = new State(new int[]{19,43,4,-28,10,-28,21,-28});
    ...
    states[49] = new State(new int[]{22,50,13,13,14,23});
    states[50] = new State(new int[]{25,18,3,4,5,31,11,35,12,40,20,48,4,-12,10,-12,21,-12},new int[]{-6,51,-7,9,-3,10,-8,29,-9,30,-10,34,-12,39,-11,46,-14,47});
    states[51] = new State(new int[]{21,52,4,-29,10,-29});
    states[52] = new State(new int[]{25,18,3,4,5,31,11,35,12,40,20,48,4,-12,10,-12,21,-12},new int[]{-6,53,-7,9,-3,10,-8,29,-9,30,-10,34,-12,39,-11,46,-14,47});
    ...
    rules[29] = new Rule(-14, new int[]{20,-2,22,-6});
    rules[30] = new Rule(-14, new int[]{20,-2,22,-6,21,-6});

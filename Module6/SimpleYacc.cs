...
public enum Tokens {
    ...
    TO=13,IF=14,THEN=15,ELSE=16,WRITE=17,LEFT_BRACKET=18,
    RIGHT_BRACKET=19,VAR=20,COMMA=21,PLUS=22,MINUS=23,MUL=24,
    DIVISION=25,INUM=26,RNUM=27,ID=28};
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "for", "write", "if", "stlist", "block", "identlist", "var", "progr", "$accept", 
      };

  static Parser() {
    states[0] = new State(new int[]{3,4},new int[]{-17,1,-14,3});
    states[1] = new State(new int[]{2,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-13,5,-6,44,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[5] = new State(new int[]{4,6,7,7});
    states[6] = new State(-27);
    states[7] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-6,8,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{6,11});
    states[11] = new State(new int[]{28,18,26,19,18,20},new int[]{-1,12,-3,28,-4,27,-2,17});
    states[12] = new State(new int[]{22,13,23,23,4,-17,7,-17,11,-17,16,-17,13,-17});
    states[13] = new State(new int[]{28,18,26,19,18,20},new int[]{-3,14,-4,27,-2,17});
    states[14] = new State(new int[]{24,15,25,25,22,-19,23,-19,4,-19,7,-19,11,-19,16,-19,13,-19,19,-19,28,-19,3,-19,5,-19,8,-19,10,-19,12,-19,17,-19,14,-19,20,-19,9,-19,15,-19});
    ...
    states[24] = new State(new int[]{24,15,25,25,22,-20,23,-20,4,-20,7,-20,11,-20,16,-20,13,-20,19,-20,28,-20,3,-20,5,-20,8,-20,10,-20,12,-20,17,-20,14,-20,20,-20,9,-20,15,-20});
    states[25] = new State(new int[]{28,18,26,19,18,20},new int[]{-4,26,-2,17});
    states[26] = new State(-23);
    states[27] = new State(-21);
    states[28] = new State(new int[]{24,15,25,25,22,-18,23,-18,4,-18,7,-18,11,-18,16,-18,13,-18,19,-18,28,-18,3,-18,5,-18,8,-18,10,-18,12,-18,17,-18,14,-18,20,-18,9,-18,15,-18});
    states[29] = new State(-6);
    states[30] = new State(-7);
    states[31] = new State(new int[]{28,18,26,19,18,20},new int[]{-1,32,-3,28,-4,27,-2,17});
    states[32] = new State(new int[]{22,13,23,23,28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-6,33,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    ...
    states[37] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-6,38,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[38] = new State(-29);
    states[39] = new State(-9);
    states[40] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-13,41,-6,44,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[41] = new State(new int[]{11,42,7,7});
    states[42] = new State(new int[]{28,18,26,19,18,20},new int[]{-1,43,-3,28,-4,27,-2,17});
    states[43] = new State(new int[]{22,13,23,23,4,-30,7,-30,11,-30,16,-30});
    ...
    states[50] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-6,51,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[51] = new State(-31);
    states[52] = new State(-11);
    states[53] = new State(new int[]{18,54});
    states[54] = new State(new int[]{28,18,26,19,18,20},new int[]{-1,55,-3,28,-4,27,-2,17});
    states[55] = new State(new int[]{19,56,22,13,23,23});
    states[56] = new State(-32);
    states[57] = new State(-12);
    states[58] = new State(new int[]{28,18,26,19,18,20},new int[]{-1,59,-3,28,-4,27,-2,17});
    states[59] = new State(new int[]{15,60,22,13,23,23});
    states[60] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-6,61,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[61] = new State(new int[]{16,62,4,-33,7,-33,11,-33});
    states[62] = new State(new int[]{28,18,3,4,5,31,8,35,10,40,12,46,17,53,14,58,20,65},new int[]{-6,63,-5,9,-2,10,-14,29,-7,30,-8,34,-9,39,-10,45,-11,52,-12,57,-16,64});
    states[63] = new State(-34);
    states[64] = new State(-13);
    states[65] = new State(new int[]{28,18},new int[]{-15,66,-2,69});
    states[66] = new State(new int[]{21,67,4,-35,7,-35,11,-35,16,-35});
    ...
    rules[2] = new Rule(-17, new int[]{-14});
    rules[3] = new Rule(-13, new int[]{-6});
    rules[4] = new Rule(-13, new int[]{-13,7,-6});
    rules[5] = new Rule(-6, new int[]{-5});
    rules[6] = new Rule(-6, new int[]{-14});
    ...
    rules[15] = new Rule(-15, new int[]{-15,21,-2});
    ...
    rules[26] = new Rule(-4, new int[]{18,-1,19});
    rules[27] = new Rule(-14, new int[]{3,-13,4});
    rules[28] = new Rule(-7, new int[]{5,-1,-6});
    rules[29] = new Rule(-8, new int[]{8,-1,9,-6});
    rules[30] = new Rule(-9, new int[]{10,-13,11,-1});
    rules[31] = new Rule(-10, new int[]{12,-5,13,-1,9,-6});
    rules[32] = new Rule(-11, new int[]{17,18,-1,19});
    rules[33] = new Rule(-12, new int[]{14,-1,15,-6});
    rules[34] = new Rule(-12, new int[]{14,-1,15,-6,16,-6});
    rules[35] = new Rule(-16, new int[]{20,-15});
  }
...
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].varVal; }
        break;
      case 14: // identlist -> ident
{ 
                	CurrentSemanticValue.varVal = new VarDefNode(ValueStack[ValueStack.Depth-1].eVal); 
               }
        break;
      case 15: // identlist -> identlist, COMMA, ident
{ 
...
{ CurrentSemanticValue.eVal = new BinaryNode(ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].eVal, ValueStack[ValueStack.Depth-2].chVal); }
        break;
...
{ CurrentSemanticValue.eVal = new IntNumNode(ValueStack[ValueStack.Depth-1].iVal); }
        break;
      case 26: // F -> LEFT_BRACKET, expr, RIGHT_BRACKET
...
{ CurrentSemanticValue.stVal = new ForNode(ValueStack[ValueStack.Depth-5].stVal, ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 32: // write -> WRITE, LEFT_BRACKET, expr, RIGHT_BRACKET
{ CurrentSemanticValue.stVal = new WriteNode(ValueStack[ValueStack.Depth-2].eVal); }
        break;
      case 33: // if -> IF, expr, THEN, statement
...
{ CurrentSemanticValue.stVal = new IfElseNode(ValueStack[ValueStack.Depth-5].eVal, ValueStack[ValueStack.Depth-3].stVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
    }
  }
